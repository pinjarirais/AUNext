...
import ChangePinForm1 from "./change-pin-form1";
import ChangePinForm2 from "./change-pin-form2";
import ChangePinForm3 from "./change-pin-form3";
...
function ChangePinClient({ userId }) {
  ...
  return (
    <>
      ...
      {pin && <ChangePinForm3 cardNo={cardNo} toast={toast} userId={userId} />}
    </>
  );
}
